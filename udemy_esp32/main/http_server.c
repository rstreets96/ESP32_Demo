...
//static esp_err_t http_server_test_handler(httpd_req_t *req)
//{
//	ESP_LOGI(TAG, "Test Page requested");
...
//				.uri = "/test",
//				.method = HTTP_GET,
//				.handler = http_server_test_handler,
//				.user_ctx = NULL
//		};
//		if(httpd_register_uri_handler(http_server_handle, &test_uri) == ESP_OK)
//		{
//			ESP_LOGI(TAG, "Test Handler Success");
//		}
